                        ...
                        <div class="col-sm-6">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<button type="submit" onclick="addToCart()" href="#" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</button>
									</div>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
                                        @if(session()->get('language') == 'hindi')  {!! $product->long_descp_hin !!}
									...
									<div class="product-tab">
										...
										<div class="product-add-review">
											...
											<div class="review-form">
												@guest 
												<p><b>For Your Product Review. Please </b><a href="{{ route('login') }}">Login Here!..</a></p>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
           ...
           @endif  
			...
			@if($product->discount_price == NULL)
                <div class="product-price"> <span class="price">{{ $product->selling_price }} </span> </div><!-- /.product-price -->
            @else                         
                <div class="product-price"> <span class="price"> {{ $product->discount_price }} </span> <span class="price-before-discount">{{ $product->selling_price }}</span>
				</div><!-- /.product-price -->
            @endif

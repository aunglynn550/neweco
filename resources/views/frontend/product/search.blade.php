              ...
              <div class="sidebar-widget-body">
                ...
                @foreach($categories as $category)
                    ...
                    <div class="accordion-heading"> <a href="#collapse{{ $category->id }}" data-toggle="collapse" class="accordion-toggle collapsed"> 
                        @if(session()->get('language') == 'china') {{ $category->category_name_chi }} @else {{ $category->category_name_en }} @endif </a> </div>
                    <!-- /.accordion-heading -->
                    ...
                    @foreach($subcategories as $subcategory)
                        ...
                        <li><a href="{{ url('subcategory/product/'.$subcategory->id.'/'.$subcategory->subcategory_slug_en ) }}">
                            @if(session()->get('language') == 'china') {{ $subcategory->subcategory_name_chi }} @else {{ $subcategory->subcategory_name_en }} @endif</a></li>
